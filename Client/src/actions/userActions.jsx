...
//register user
export const register = (name, email, password, role, university, contact) => async(dispatch) => {
    try{
        ...
        const {data} = await axios.post(`http://localhost:4000/api/v1/register`,{name, email, password, role, university, contact}, config);
